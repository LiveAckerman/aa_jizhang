...
- [开发完成报告](./docs/一起分账吧-登录功能开发完成报告.md) - 完整开发报告
...
### 核心业务
- ✅ 账本创建、编辑、删除、归档、自定义分组和搜索
- ✅ 邀请、加入、退出账本和成员移除（长按头像，owner 专属）
- ✅ 共享账、私密账、四种分账（平均/比例/份额/指定金额）、图片凭证、地图选点和多币种换算
- ✅ OCR 识别付款截图自动记账（逐条编辑提交）
- ✅ 智能结算（贪心最优转账方案、单条/批量结算标记）
- ✅ 账单列表内嵌"我应付"金额
- ✅ 基础统计（总额、分类分布、近 6 个月趋势）
